# Template — Capability Specification

A normative, implementation-independent template of the Capability library. Copy it to author
a Capability specification; every section must be populated (no placeholders) to pass the
...
5. **Capability Content** — the Capability Specifications, Capability Relationships, Capability Dependencies, Capability Boundaries … this specification defines.
...
- Declare the single owning authority (Product Architect) and the owning chapter
  ([Chapter 02](../../../handbook/02-product-thinking/CHAPTER.md)).
