...
Guidance for using the Capability specification library. Part of the
[Specification Framework](../../SPECIFICATION_FRAMEWORK.md).

## Purpose
Specify specify the durable capabilities a product provides, and their relationships, dependencies, boundaries, and evolution.

## When to use
Use this library when a Capability concern needs normative intent before the work it governs
...
Derives from the discovery library and constrains
the domains library; all links are
bidirectional per [Traceability](../../SPECIFICATION_TRACEABILITY.md).

## Common mistakes
- Redefining a concept owned by [Chapter 02](../../../handbook/02-product-thinking/CHAPTER.md)
...
## Review guidance
Apply the Product, Architecture review dimensions (see [Specification Review](../../SPECIFICATION_REVIEW.md)).
