...
Guidance for using the Vision specification library. Part of the
[Specification Framework](../../SPECIFICATION_FRAMEWORK.md).

## Purpose
Specify specify the enduring intent of a product: its vision, objectives, outcomes, and the constraints and assumptions that frame it.

## When to use
Use this library when a Vision concern needs normative intent before the work it governs
...
Derives from none — it heads the chain and constrains
the discovery library; all links are
bidirectional per [Traceability](../../SPECIFICATION_TRACEABILITY.md).

## Common mistakes
- Redefining a concept owned by [Chapter 01](../../../handbook/01-platform-vision/CHAPTER.md)
...
## Review guidance
Apply the Business, Product review dimensions (see [Specification Review](../../SPECIFICATION_REVIEW.md)).
