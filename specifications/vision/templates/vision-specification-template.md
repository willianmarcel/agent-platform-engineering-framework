# Template — Vision Specification

A normative, implementation-independent template of the Vision library. Copy it to author
a Vision specification; every section must be populated (no placeholders) to pass the
...
5. **Vision Content** — the Vision Specifications, Mission Specifications, Business Objectives, Product Outcomes … this specification defines.
...
- Declare the single owning authority (Product Architect / Enterprise Architect) and the owning chapter
  ([Chapter 01](../../../handbook/01-platform-vision/CHAPTER.md)).
