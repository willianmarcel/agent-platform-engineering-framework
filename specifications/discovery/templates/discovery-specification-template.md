# Template — Discovery Specification

A normative, implementation-independent template of the Discovery library. Copy it to author
a Discovery specification; every section must be populated (no placeholders) to pass the
...
5. **Discovery Content** — the Discovery Specifications, Stakeholders, Personas, Business Problems … this specification defines.
