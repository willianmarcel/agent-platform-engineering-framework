# Backlog — Reference Guide

Guidance for using the Backlog specification library. Part of the
[Specification Framework](../../SPECIFICATION_FRAMEWORK.md).

## Purpose
Specify specify how work is decomposed and governed as a backlog — epics, features, stories, and tasks — as methodology, never prescribing any Agile framework.

## When to use
Use this library when a Backlog concern needs normative intent before the work it governs
...
Derives from the ui library and constrains
the roadmap library; all links are
bidirectional per [Traceability](../../SPECIFICATION_TRACEABILITY.md).

## Common mistakes
- Redefining a concept owned by [Chapter 04](../../../handbook/04-development-methodology/CHAPTER.md)
...
## Review guidance
Apply the Product, Governance review dimensions (see [Specification Review](../../SPECIFICATION_REVIEW.md)).
