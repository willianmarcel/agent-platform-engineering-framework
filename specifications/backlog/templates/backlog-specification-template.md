# Template — Backlog Specification

A normative, implementation-independent template of the Backlog library. Copy it to author
a Backlog specification; every section must be populated (no placeholders) to pass the
...
5. **Backlog Content** — the Engineering Backlog, Capability Decomposition, Epics, Features … this specification defines.
