...
A normative, implementation-independent template of the Domain library. Copy it to author
a Domain specification; every section must be populated (no placeholders) to pass the
...
5. **Domain Content** — the Domain Specifications, Bounded Context Specifications, Domain Responsibilities, Domain Relationships … this specification defines.
...
- Declare the single owning authority (Domain Expert) and the owning chapter
  ([Chapter 05](../../../handbook/05-domain-driven-design/CHAPTER.md)).
