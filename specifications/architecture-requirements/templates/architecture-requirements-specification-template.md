# Template — Architecture Requirements Specification

A normative, implementation-independent template of the Architecture Requirements library. Copy it to author
a Architecture Requirements specification; every section must be populated (no placeholders) to pass the
...
5. **Architecture Requirements Content** — the Architecture Drivers, Architecture Constraints, Quality Attribute Scenarios, Business Constraints … this specification defines.
...
- Declare the single owning authority (Platform Architect) and the owning chapter
  ([Chapter 06](../../../handbook/06-reference-architecture/CHAPTER.md)).
