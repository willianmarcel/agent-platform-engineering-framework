# Template — Roadmap Specification

A normative, implementation-independent template of the Roadmap library. Copy it to author
a Roadmap specification; every section must be populated (no placeholders) to pass the
...
5. **Roadmap Content** — the Roadmap Specifications, Evolution Strategy, Capability Evolution, Release Objectives … this specification defines.
...
- Declare the single owning authority (Product Architect / Enterprise Architect) and the owning chapter
  ([Chapter 20](../../../handbook/20-roadmap/CHAPTER.md)).
