# Template — Experience Specification

A normative, implementation-independent template of the Experience library. Copy it to author
a Experience specification; every section must be populated (no placeholders) to pass the
...
5. **Experience Content** — the Experience Specifications, Interaction Specifications, Navigation Specifications, Accessibility Specifications … this specification defines.
...
- Declare the single owning authority (Product Architect / Technical Writer) and the owning chapter
  ([Chapter 17](../../../handbook/17-ui-ux/CHAPTER.md)).
